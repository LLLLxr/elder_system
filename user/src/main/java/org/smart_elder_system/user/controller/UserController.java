...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<Page<UserVO>> getUserPage(
        ...
        Page<UserVO> result = userService.getUserPage(pageable, userDTO);
    ...
    public ResponseEntity<UserVO> updateCurrentUser(
        ...
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        UserVO currentUser = userService.findByUsername(username);
        if (currentUser == null) {
        ...
        // 返回更新后的用户信息
        UserVO updatedUser = userService.findByUsername(username);
