...
export const USER_ME_ELDER_BINDINGS_PATH = '/api/users/me/elder-bindings';
export const USER_ME_ELDER_BINDINGS_SELF_PATH = '/api/users/me/elder-bindings/self';
export const USER_ME_ELDER_BINDING_REQUESTS_PATH = '/api/users/me/elder-binding-requests';
export const USER_ME_FAMILY_ELDER_BINDING_REQUESTS_PATH = '/api/users/me/elder-binding-requests/family';
...
export const CARE_RENEWAL_CONTEXT_LATEST_BY_APPLICANT_PATH = '/care-orchestration/renewal-context/latest/by-applicant';
export const CARE_RENEWAL_REVIEW_PATH = '/care-orchestration/renewals/review';
export const CARE_RENEWAL_CONFIRM_PATH = (agreementId: number) => `/care-orchestration/renewals/${agreementId}/confirm`;
export const CARE_RENEWAL_DECLINE_PATH = (agreementId: number) => `/care-orchestration/renewals/${agreementId}/decline`;
...
export const ADMISSION_FAMILY_VISIT_RESERVATION_RULES_PATH = '/admission/family-visit-reservation-rules';
...
export const ADMISSION_FAMILY_VISIT_MY_RESERVATIONS_PATH = '/admission/family-visit-reservations/my';
export const CONTRACT_SCOPE_PATH = '/contract/module-scope';
export const CONTRACT_AGREEMENT_PATH = (agreementId: number) => `/contract/agreements/${agreementId}`;
export const CONTRACT_AGREEMENT_BY_APPLICATION_PATH = (applicationId: number) => `/contract/agreements/by-application/${applicationId}`;
export const CONTRACT_AGREEMENT_SIGN_PATH = '/contract/agreements/sign';
...
export const CARE_DELIVERY_MY_TASKS_PATH = '/care-delivery/my-tasks';
export const CARE_DELIVERY_MY_CHECK_INS_PATH = '/care-delivery/my-check-ins';
export const CARE_DELIVERY_MY_TASK_CHECK_IN_PATH = (servicePlanId: number) => `/care-delivery/my-tasks/${servicePlanId}/check-in`;
export const CARE_DELIVERY_FAMILY_SERVICE_PLANS_PATH = (elderId: number) => `/care-delivery/family/service-plans/${elderId}`;
export const CARE_DELIVERY_FAMILY_CHECK_INS_PATH = (elderId: number) => `/care-delivery/family/check-ins/${elderId}`;
export const CARE_DELIVERY_FAMILY_NURSE_CARE_RECORDS_PATH = (elderId: number) => `/care-delivery/family/nurse-care-records/${elderId}`;
export const HEALTH_FAMILY_DOCTOR_ROUND_RECORDS_PATH = (elderId: number) => `/health/family/doctor-round-records/${elderId}`;
...
export const QUALITY_CAREGIVER_QUALIFICATION_MY_APPLICATIONS_PATH = '/quality/caregiver-qualification-applications/my';
