...
public class PermissionController {
    ...
    public ResponseEntity<List<PermissionPo>> getPermissionList(
            @Parameter(description = "关键词") @RequestParam(required = false) String keyword) {

        List<PermissionPo> permissions = permissionService.getPermissionList(keyword);
    ...
    @GetMapping("/tree")
    @PreAuthorize("hasAuthority('PERMISSION_MANAGE')")
    public ResponseEntity<List<PermissionPo>> getPermissionTree() {

        List<PermissionPo> permissionTree = permissionService.getPermissionTree();
    ...
    @PreAuthorize("hasAuthority('PERMISSION_MANAGE')")
    public ResponseEntity<PermissionPo> getByPermissionCode(
            @Parameter(description = "权限编码") @PathVariable String permissionCode) {

        PermissionPo permission = permissionService.getByPermissionCode(permissionCode);
    ...
    @PreAuthorize("hasAuthority('PERMISSION_MANAGE')")
    public ResponseEntity<List<PermissionPo>> getPermissionsByRoleId(
            @Parameter(description = "角色ID") @PathVariable Long roleId) {

        List<PermissionPo> permissions = permissionService.getPermissionsByRoleId(roleId);
        return ResponseEntity.ok(permissions);
    }
    ...
    @PreAuthorize("hasAuthority('PERMISSION_MANAGE')")
    public ResponseEntity<List<PermissionPo>> getPermissionsByUserId(
            @Parameter(description = "用户ID") @PathVariable Long userId) {

        List<PermissionPo> permissions = permissionService.getPermissionsByUserId(userId);
        return ResponseEntity.ok(permissions);
    }
